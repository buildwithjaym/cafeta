...
export function GoogleAuthButton({
  ...
  return (
    <button
      ...
      disabled={loading}
      className="group flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-black/[0.09] bg-white px-5 text-sm font-semibold text-[#17211c] transition duration-200 hover:border-black/20 hover:bg-black/[0.015] disabled:pointer-events-none disabled:opacity-60"
    >
      {loading ? (
        <>
